      ...
      <footer className="bg-dark-blue px-8 lg:px-page flex flex-col gap-y-8 xsm:gap-y-0 justify-between py-medium min-h-screen">
        <section className="flex flex-col mb-4 gap-y-4 xsm:mb-0 xsm:gap-y-0 xsm:flex-row justify-center xsm:justify-between items-center">
          <div className="flex flex-col xsm:flex-row gap-2 items-center">
            <img src={`${window.location.origin}/images/simpleLogo.png`} alt="LeCodePartagé's logo" />
        ...
        <section className="flex flex-row justify-center xsm:justify-between items-center">
          <div className="flex flex-col gap-4 xsm:gap-12">
            <div>
              <h2 className="text-white-color font-bold text-2xl text-center xsm:text-left">Le Code Partagé</h2>
              <h3 className="text-white-color text-center xsm:text-left">
                Votre guide sur l’<span className="text-light-blue">Open</span> Source{' '}
                <span className="text-light-red">Francais</span>{' '}
              </h3>
            ...
            <div className="flex flex-col gap-4">
              <h2 className="text-light-red font-bold text-2xl text-center xsm:text-left">A propos :</h2>
              <div className="grid grid-cols-1 xsm:grid-cols-2 sm:grid-cols-3 grid-rows-6 xsm:grid-rows-3 sm:grid-rows-2 flex-row gap-4 xsm:gap-8 items-center text-center xsm:text-left">
                <Link to="/a-propos" className="text-white-color hover:underline cursor-pointer">
                  Qui sommes-nous ?
                </Link>
                <Link to="/contacte" className="text-white-color hover:underline cursor-pointer">
                  Nous contacter
                </Link>

                <Link to="/cgu" className="text-white-color hover:underline cursor-pointer">
                  CGU
                </Link>
                <Link to="/confidentialité" className="text-white-color hover:underline cursor-pointer">
                  Confidentialité
                </Link>

                <Link to="/mentions-légales" className="text-white-color hover:underline cursor-pointer">
                  Mentions légales
                </Link>
        ...
        <div className="flex flex-col xsm:flex-row gap-y-4 xsm:gap-y-0 items-center xsm:justify-between">
          <div className="flex flex-col xsm:flex-row gap-2 items-center">
            <img src={`${window.location.origin}/images/simpleLogo.png`} alt="LeCodePartagé's logo" className="w-8" />
            <h4 className="text-white-color text-center xsm:text-left">@2023 LeCodePartagé - Fait avec ❤️ en France</h4>
          </div>
          <LinkedinButton />
        </div>
      </footer>
