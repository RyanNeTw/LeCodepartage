            ...
            <section>
                ...
                <ul className="w-full flex flex-wrap pt-12 justify-between gap-8">
                    {members?.map((member, index) => (
                        <li key={index} className="w-full sm:w-5/12">
                            <AuthorCard
                                author={member}
                                isBackground={false}
                                isRow={true}
    ...
    return (
        <div>
            ...
            <div className="flex flex-row-reverse items-center gap-2">
                <a href={member.attributes.linkedin} target="_blank" className="hover:opacity-70 hover:scale-110">
                    <LinkedIn />
                </a>
                <a href={member.attributes.GitHub} target="_blank" className="hover:opacity-70 hover:scale-110">
                    <Github />
                </a>
            </div>
        </div>
