        ...
        <>
            <section className="bg-dark-blue px-8 lg:px-page flex flex-row justify-between py-12 relative">
                ...
                <div className="flex flex-col gap-12 justify-between w-full">
                    <h2 className="text-white-color text-2xl">Les prochains événements :</h2>
                        ...
                        {events?.length > 0
                            ? events?.map((event, index) => (
                                  ...
                                  >
                                      ...
                                      <div className="text-white-color font-bold">{event?.attributes?.eventName}</div>
                                  </a>
                              ))
                            : array.map((e, index) => (
                                  <li
                ...
                <img src="./images/calender.svg" alt="calender" className="hidden md:block" />
            </section>
        </>
    );
};
