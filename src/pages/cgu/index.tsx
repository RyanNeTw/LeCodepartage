        ...
        <>
            <div className="px-8 lg:px-page py-medium min-h-screen flex flex-col gap-4">
                <div className="self-center flex flex-col items-center">
                    <h1 className="text-3xl text-light-red font-bold">Conditions générales d’utilisation du site</h1>
                    <h4 className="text-xl">Retrouvez nos conditions générales d’utilisation (CGU).</h4>
                </div>
